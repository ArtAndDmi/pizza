            ...
            <SheetContent className={'flex flex-col justify-between pb-0 bg-[#f4f1ee]'}>
                ...
                {!totalAmount && (
                    <div className={'flex flex-col items-center justify-center w-72 mx-auto'}>
                        <img src="https://github.com/Archakov06/next-pizza/blob/main/public/assets/images/empty-box.png?raw=true" alt="Empty cart" width={120} height={120} />
...

                {
                    totalAmount > 0 && (
                        <>
                            <div className={'-mx-6 mt-5 overflow-auto scrollbar flex flex-col gap-2 flex-1'}>
                                {
                                    items.map(item => (
                                        <CartDrawerItem
                                            key={item.id}
